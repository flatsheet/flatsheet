...
var templates = {
  modal: Handlebars.compile(fs.readFileSync(__dirname + '/views/modal.html', 'utf8')),
  newSheet: Handlebars.compile(fs.readFileSync(__dirname + '/views/new-blank-sheet.html', 'utf8'))
};
